    ...
    return Scaffold(
        ...
        body: Center(
          ...
          child: Column(children: [
            ...
            SizedBox(
                height: 45.0,
                child: SettingsModifierWidget(
                    valueName:
                        'Work Time') //this might get a bit messy and hard to upscale. but it works.
            ...
            SizedBox(
                height: 45.0,
                child: SettingsModifierWidget(
                    valueName: 'Break Time') //is this the way to do this?
      ...
      return Row(
        children: <Widget>[
          ...
          SizedBox(
            ...
            child: Center(
                child: Text(
                    MyHomePageState.mainVars[widget.valueName].toString())),
          ),
    ...
    setState(() {
      ...
      if (MyHomePageState.mainVars[dataName] is int &&
        ...
        MyHomePageState.mainVars[dataName] = prefs
            .getInt(dataName); //we still need to actually update the mainVars.
      }
    });
  }
